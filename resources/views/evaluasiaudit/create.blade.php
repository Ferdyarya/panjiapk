...
@section('content')
    ...
    <title>Surat Evaluasi Audit</title>
    ...
    <body>
        <div class="container-fluid">
            <div class="card" style="border-radius: 15px;">
                <div class="card-body">
                    <h1 class="text-center mb-4">Tambah Data Surat Evaluasi Audit</h1>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-8">
                                <div class="card" style="border-radius: 10px;">
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('evaluasiaudit.store') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="auditor"
                                                    ...
                                                    id="auditor" placeholder="Masukkan Auditor"
                                                    value="{{ old('auditor') }}" required>
                                                @error('auditor')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="saran" class="form-control @error('saran') is-invalid @enderror"
                                                    id="saran" placeholder="Masukkan saran" value="{{ old('saran') }}" required></textarea>
                                                @error('saran')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
