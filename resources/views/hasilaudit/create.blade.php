    ...
    <body>
        <div class="container-fluid">
            <div class="card" style="border-radius: 15px;">
                <div class="card-body">
                    <h1 class="text-center mb-4">Tambah Data Surat Hasil Audit</h1>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-8">
                                <div class="card" style="border-radius: 10px;">
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('hasilaudit.store') }}"
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-select" name="id_mastercabang"
                                                    data-placeholder="Pilih Cabang" id="judulbuku"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="temuan" class="form-control @error('temuan') is-invalid @enderror"
                                                    id="temuan" placeholder="Masukkan temuan" value="{{ old('temuan') }}" required></textarea>
                                                @error('temuan')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="nilai"
                                                    ...
                                                    id="nilai" placeholder="Masukkan Nilai"
