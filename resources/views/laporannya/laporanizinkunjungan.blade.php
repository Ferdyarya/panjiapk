            ...
            <div class="card-body">
                <div class="content-wrapper">
                    ...
                    <div class="content-header">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h3 class="m-0">Laporan Data Surat Izin Kunjungan</h3>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Laporan Data Surat Izin Kunjungan</li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div>
                    ...
                    <div class="container">
                        <form action="{{ route('laporanizinkunjungan') }}" method="GET" class="row">
                            ...
                            <div class="col-md-2 pt-4">
                                @if (!empty($filter))
                                    <a href="{{ route('laporanizinkunjunganpdf', $filter) }}"
                                        class="btn btn-danger btn-block">Export PDF</a>
                                @else
                                    <a href="{{ route('laporanizinkunjunganpdf', 'all') }}"
                                        class="btn btn-danger btn-block">Export PDF</a>
                                @endif
                            </div>
                        </form>
                    ...
                    <div>
                        <table class="table table-hover">
                            ...
                            <tbody>
                              ...
                              $no=1;
                              @endphp --}}
                                @foreach ($laporanizinkunjungan as $index => $item)
                                    <tr>
