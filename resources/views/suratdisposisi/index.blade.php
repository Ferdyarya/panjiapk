                ...
                <div class="content-wrapper">
                    ...
                    <div class="container">
                        ...
                        <div class="row g-3 align-items-center mb-4">
                            <div class="col-auto">
                                <form action="suratdisposisi" method="GET" class="d-flex">
                                    ...
                                    <select name="perihal" class="form-select me-2">
                                        ...
                                        @foreach ($perihal as $item)
                                            <option value="{{ $item }}"
                                                {{ request('perihal') == $item ? 'selected' : '' }}>{{ $item }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($suratdisposisi as $index => $item)
                                        <tr>
                                            ...
                                            @if (Auth::user()->hakakses('admin'))
                                                <td class="px-6 py-2">
                                                    <a href="{{ route('suratdisposisi.edit', $item->id) }}"
                                                        class="btn btn-primary">Edit</a>
                                                    <form action="{{ route('suratdisposisi.destroy', $item->id) }}"
